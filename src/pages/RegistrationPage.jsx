...
export default function RegistrationPage() {
  ...
  // Ajuste o estado inicial para 'Enfermagem'
      ...
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: Dr(a). Maria da Silva"/>
          </div>
          <div>
